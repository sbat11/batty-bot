...
async def show_queue(interaction: discord.Interaction):
    song_query = interaction.response.defer()
...
async def play(interaction: discord.Interaction, song_query: str):
    ...
    if voice_client.is_playing() or voice_client.is_paused():
        await interaction.followup.send(f"Added to queue: **{title}**", view=MusicControls())
    else:
        await interaction.followup.send(f"Now playing: **{title}**", view=MusicControls())
